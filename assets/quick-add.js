      ...
      show(opener) {
        ...
        fetch(opener.getAttribute('data-product-url'))
          ...
          .then((responseText) => {
            ...
            if (this.productElement.querySelector('variant-selects'))
              this.productElement.querySelector(
                'variant-selects'
              ).dataset.hasFiltering = 'false';
