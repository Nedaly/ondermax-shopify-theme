    ...
    class MediaGallery extends HTMLElement {
      ...
      setActiveMedia(
        ...
        if (filtering && currentVariant) {
          const allSlides = this.querySelectorAll(
            '.product__media-item, .thumbnail-list__item, .slider-counter__link'
          );
          allSlides.forEach((slide) => {
            if (
              slide.dataset.alt === currentVariant[this.filteringOption] ||
              slide.dataset.alt === 'always_display'
            ) {
      ...
      setActiveThumbnail(thumbnail) {
        ...
        if (this.elements.thumbnails.isSlideVisible(thumbnail, false, 10, true))
          return;
